...
class LobbySettings {
    ...
    updateAnswerTime(answerTime) {
        ...
        if (answerTime <= 0)
        {
            console.error('Error: time to answer a question cant be less than or equal to 0 seconds.');
            return false;
        }
    ...
    updateNumQuestions(numQuestions) {
        ...
        if (numQuestions <= 0)
        {
            console.error("Error: number of questions can't be less than or equal to 0");
            return false;
        }
